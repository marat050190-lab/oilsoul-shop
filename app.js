  ...
  if (currentFilter === 'all' || currentFilter === 'custom') {
    ...
    customCard.innerHTML =
      ...
      '<div class="custom-order-card-body">' +
        ...
        '<div class="custom-order-card-price">99 GRAM' + (tonPrice ? ' (~$' + (99 * tonPrice.usd).toFixed(0) + ')' : '') + '</div>' +
    ...
    '<div class="detail-content">' +
      ...
      '<div class="custom-form">' +
        ...
        '<div class="custom-section custom-conditions">' +
          ...
          '<div class="custom-condition-row"><span>' + t('custom_price') + '</span><span class="custom-condition-value">99 GRAM' + (tonPrice ? ' (~$' + (99 * tonPrice.usd).toFixed(0) + ')' : '') + '</span></div>' +
