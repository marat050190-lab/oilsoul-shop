        ...
        if chat_id:
            ...
            if is_russia:
                client_msg = (
                    ...
                    '2. Присылаете нам его адрес или название пункта\n'
                    ...
                    '6. Когда посылка прибудет — пришлём Вам трек-номер и код получения\n\n'
                    '⚠️ Срок хранения в постамате ограничен. Пожалуйста, заберите посылку вовремя.\n\n'
                    'Пришлите, пожалуйста, адрес или название удобного пункта СДЭК 👇\n'
                    'Найти пункт выдачи: https://www.cdek.ru/ru/offices/'
                )
            else:
                client_msg = (
                    f'Приветствуем! Рады, что Вас заинтересовала картина 🎨\n\n'
                    f'Вы выбрали формат доставки с согласованием в Telegram.\n\n'
                    f'Для отправки картины в вашу страну ({delivery.get("deliveryCountry", "—")}) нам потребуется <b>полный адрес доставки</b>: улица, дом, индекс.\n\n'
                    'Пожалуйста, напишите нам полный адрес — мы уточним стоимость и сроки доставки, после чего пришлём реквизиты для оплаты.'
                )
